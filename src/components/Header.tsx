      ...
      <div className="mx-auto flex h-16 max-w-3xl items-center justify-between px-4 sm:px-6">
        ...
        <nav className="flex items-center">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-1.5 rounded-lg border border-border-subtle bg-bg-secondary/60 px-3 py-1.5 text-xs text-text-secondary transition-all hover:border-border-default hover:text-text-primary no-underline"
          >
            <svg
              className="h-4 w-4"
              fill="currentColor"
